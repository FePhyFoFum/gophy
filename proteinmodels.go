...
type ProteinModel struct {
	BF        []float64 // residue frequencies, order is A,R,N,D,C,Q,E,G,H,I,L,K,M,F,P,S,T,W,Y,V (PAML style)
	MBF       []float64 // model res frequencies
...
func NewProteinModel() *ProteinModel {
	return &ProteinModel{NumStates: 20}
}

//SetEqualBF set all equal
func (d *ProteinModel) SetEqualBF() {
	for i := range d.BF {
		d.BF[i] = float64(0.05)
	}
}
...
func (d *ProteinModel) SetEmpiricalBF() {
	d.BF = d.EBF
}

// SetModelBF set all to frequencies from empirical model
func (d *ProteinModel) SetModelBF() {
	d.BF = d.MBF
}
...
// CHANGE THIS TO ALLOW USER SPEC OF PROTEIN RATES
func (d *ProteinModel) SetRateMatrix(params []float64) {
...
func (d *ProteinModel) SetBaseFreqs(basefreq []float64) {
	d.BF = basefreq
}
...
func (d *ProteinModel) SetupQJC1Rate(rt float64) {
	d.Ps = make(map[float64]*mat.Dense)
	d.Q = mat.NewDense(d.NumStates, d.NumStates, nil)
...
func (d *ProteinModel) SetupQMk(rt []float64, sym bool) {
	d.Ps = make(map[float64]*mat.Dense)
	d.Q = mat.NewDense(d.NumStates, d.NumStates, nil)
	cc := 0
	for i := 0; i < d.NumStates; i++ {
...
func (d *ProteinModel) DecomposeQ() {
...
func (d *ProteinModel) SetScaledRateMatrix(params []float64, sym bool) {
	d.R = mat.NewDense(d.NumStates, d.NumStates, nil)
	cc := 0
	lasti := 0
	lastj := 0
...
func (d *ProteinModel) ExpValue(iv []float64, blen float64) {
	for i, j := range iv {
...
func (d *ProteinModel) ExpValueFirstD(blen float64) (x *mat.Dense) {
...
func (d *ProteinModel) ExpValueSecondD(blen float64) (x *mat.Dense) {
	x = mat.NewDense(d.NumStates, d.NumStates, nil)
	for i := 0; i < d.NumStates; i++ {
...
func (d *ProteinModel) SetP(blen float64) {
...
func (d *ProteinModel) SetPSimple(blen float64) {
	P := mat.NewDense(d.NumStates, d.NumStates, nil)
	P.Scale(blen, d.Q)
	P.Exp(P)
	//d.Lock()
...
func (d *ProteinModel) EmptyPDict() {
	d.Ps = nil
	d.Ps = make(map[float64]*mat.Dense)
}

// GetPMap get the Ps from the dictionary
func (d *ProteinModel) GetPMap(blen float64) *mat.Dense {
	//d.RLock()
...
func (d *ProteinModel) GetPCalc(blen float64) *mat.Dense {
	var P mat.Dense
	P.Scale(blen, d.Q)
	P.Exp(&P)
	//d.ExpValue(d.EigenVals, blen)
...
// GetCharMap to return the character map
func (d *ProteinModel) GetCharMap() map[string][]int {
	return d.CharMap
}

// GetNumStates return the size of the state space
func (d *ProteinModel) GetNumStates() int {
	return d.NumStates
}

// GetBF return the state frequencies
func (d *ProteinModel) GetBF() []float64 {
	return d.BF
}

// GetStochMapMatrices return matrix for stochastic mapping
func (d *ProteinModel) GetStochMapMatrices(dur float64, from int, to int) (summed *mat.Dense, summedR *mat.Dense) {
	nstates := d.NumStates
	d.DecomposeQ()

...
// DiscreteModelNew overall model struct
type DiscreteModelNew struct {
...
func (d *DiscreteModelNew) SetEqualBF() {
	for i := range d.BF {
...
func (d *DiscreteModelNew) SetEmpiricalBF() {
	d.BF = d.EBF
}

// SetModelBF set all to frequencies from empirical model
func (d *DiscreteModelNew) SetModelBF() {
	d.BF = d.MBF
}

// SetBaseFreqs needs to be done before doing SetupQGTR
func (d *DiscreteModelNew) SetBaseFreqs(basefreq []float64) {
	d.BF = basefreq
}
...
func (d *DiscreteModelNew) SetupQJC() {
	bf := []float64{}
...
func (d *DiscreteModelNew) SetupQJC1Rate(rt float64) {
	d.Ps = make(map[float64]*mat.Dense)
	d.Q = mat.NewDense(d.NumStates, d.NumStates, nil)
...
func (d *DiscreteModelNew) SetupQGTR() {
...
func (d *DiscreteModelNew) SetupQMk(rt []float64, sym bool) {
	d.Ps = make(map[float64]*mat.Dense)
	d.Q = mat.NewDense(d.NumStates, d.NumStates, nil)
	cc := 0
	for i := 0; i < d.NumStates; i++ {
...
func (d *DiscreteModelNew) DecomposeQ() {
...
func (d *DiscreteModelNew) SetRateMatrix(params []float64) {
...
func (d *DiscreteModelNew) SetScaledRateMatrix(params []float64, sym bool) {
	d.R = mat.NewDense(d.NumStates, d.NumStates, nil)
	cc := 0
	lasti := 0
	lastj := 0
...
func (d *DiscreteModelNew) ExpValue(iv []float64, blen float64) {
	for i, j := range iv {
...
func (d *DiscreteModelNew) ExpValueFirstD(blen float64) (x *mat.Dense) {
...
func (d *DiscreteModelNew) ExpValueSecondD(blen float64) (x *mat.Dense) {
	x = mat.NewDense(d.NumStates, d.NumStates, nil)
	for i := 0; i < d.NumStates; i++ {
...
func (d *DiscreteModelNew) SetP(blen float64) {
...
func (d *DiscreteModelNew) SetPSimple(blen float64) {
	P := mat.NewDense(d.NumStates, d.NumStates, nil)
	P.Scale(blen, d.Q)
	P.Exp(P)
	//d.Lock()
...
func (d *DiscreteModelNew) EmptyPDict() {
	d.Ps = nil
	d.Ps = make(map[float64]*mat.Dense)
}

// EmptyPLDict the logged one
func (d *DiscreteModelNew) EmptyPLDict() {
	d.PsL = nil
	d.PsL = make(map[float64]*mat.Dense)
}

// GetPMap get the Ps from the dictionary
func (d *DiscreteModelNew) GetPMap(blen float64) *mat.Dense {
	//d.RLock()
...
func (d *DiscreteModelNew) GetPMapLogged(blen float64) *mat.Dense {
...
func (d *DiscreteModelNew) GetPCalc(blen float64) *mat.Dense {
	var P mat.Dense
	P.Scale(blen, d.Q)
	P.Exp(&P)
	//d.ExpValue(d.EigenVals, blen)
...
func (d *DiscreteModelNew) GetCharMap() map[string][]int {
	return d.CharMap
}

// GetNumStates return the number of states
func (d *DiscreteModelNew) GetNumStates() int {
	return d.NumStates
}

// GetBF return the base frequencies
func (d *DiscreteModelNew) GetBF() []float64 {
	return d.BF
}

// GetStochMapMatrices return matrices for stochastic mapping
func (d *DiscreteModelNew) GetStochMapMatrices(dur float64, from int, to int) (summed *mat.Dense, summedR *mat.Dense) {
	nstates := d.NumStates
	d.DecomposeQ()
